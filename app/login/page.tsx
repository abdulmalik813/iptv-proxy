      ...
      <div className="w-full max-w-md border border-neutral-800 bg-neutral-950 p-6 sm:p-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-neutral-500 tracking-wide">
                {isSetup ? 'FIRST-RUN ADMINISTRATOR SETUP' : 'RESTRICTED ADMIN ACCESS'}
              </p>
            </div>
          </div>
        </div>
        ...
        {error && (
          <div
            ...
            className="mb-6 p-3 bg-rose-950/40 border border-rose-800 text-rose-300 text-xs flex items-start gap-2.5"
          >
        ...
        {isSetup && (
          <div className="mb-6 p-3 bg-neutral-900 border border-neutral-800 text-neutral-300 text-xs space-y-1">
            ...
            <p className="text-[11px] text-neutral-400">
              No administrator account was detected in SQLite. Create the master credentials below.
            </p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-9 pr-3 py-2.5 bg-black border border-neutral-800 text-white focus:border-white focus:outline-none placeholder-neutral-600 text-xs font-mono"
                placeholder="admin"
          ...
          <div className="pt-2">
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-white text-black font-bold uppercase tracking-wider hover:bg-neutral-200 transition-colors border border-white disabled:opacity-50 cursor-pointer flex items-center justify-center gap-2"
            >
              {loading ? (
        ...
        <div className="mt-8 pt-4 border-t border-neutral-900 text-[10px] text-neutral-600 flex justify-between items-center">
          <span>IPTV PROXY v1.0.0</span>
          <span>SQLITE / DOCKER WAL</span>
        </div>
      </div>
    </div>
  );
